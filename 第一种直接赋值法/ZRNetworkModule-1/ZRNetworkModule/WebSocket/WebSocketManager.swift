...
extension WebSocketManager {
    ...
    /// 内部发送数据
    public func openSendData(_ path: String, param: [String : Any]?, completion: WebSocketClosure?) {
        /// 自增
        self.packetIndex += 1
...
//            NotificationCenter.default.post(name: WebSocketManager.didReceiveDataPushNotification, object: self  , userInfo: ["result":result] )
        }
    }
