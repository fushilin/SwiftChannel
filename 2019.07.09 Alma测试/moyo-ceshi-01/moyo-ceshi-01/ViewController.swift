...
//        带有参数的传递信息
    ...
    func creatMQtt(){
        ...
        //注意，这一句代码，是可以和本地服务器进行c查看，不要写什么z定义主题的语句，首先查看ping pong等语句
//         mqtt = CocoaMQTT(clientID: clientID, host: "172.1.1.1", port: 1883)
...
//             重点，重点，重点，这个stock主题必须存在，后台才会进行信息发送，信息必须匹配
...
//        mqtt.publish("jerry", withString: "jerry-01", qos: CocoaMQTTQOS.qos0, retained: true, dup: true)
        //        在这个里面发送了消息针对主题 主题必须对应 这条o消息如过不进行限制，回一直发出去
